"""
калькулятор для выражений -2 + 3.5 * 2 - 3 ^ 2
"""
...
#вычислим операции первого приоритета (возведение в степень)
...
while i < len(actions):
    ...
    если она соответствует, то:
        ...
        -записываем результат в соседе СПРАВА
...
#вычислим операции 2го приоритета (умножение и деление)
...
while i < len(actions):
    ...
    если она соответствует, то:
        -вычисляем результат для числа в этом лействии и соседе слева
        -записываем результат в соседе СЛЕВА
        -удаляем текущее действие
    """
    action = actions[i]
    operation = action.get('opr')
...
#вычислим операции 3го приоритета (сложение и вычитание)
#-2 + 7 - 9 = -4
